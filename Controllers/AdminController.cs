...
// Đặt Controller này vào Area "Admin"
namespace EcoConnect_Hanoi.Areas.Admin.Controllers
{
    [Area("Admin")] // Khai báo đây là Controller cho Area "Admin"
    [Authorize(Roles = "Admin")] // Tất cả các action trong controller này yêu cầu role Admin
    public class AdminController : Controller
    {
        ...
        public async Task<IActionResult> CreateUser(Users user)
        {
            if (ModelState.IsValid)
            {
                ...
                return RedirectToAction(nameof(ManageUsers), new { area = "Admin" }); // Chuyển hướng về trang quản lý người dùng
            }
            return View(user);
        }
        ...
        public async Task<IActionResult> EditUser(int id)
        {
            ...
            if (user.UserId.ToString() == User.FindFirst(ClaimTypes.NameIdentifier)?.Value && user.Role == UserRole.Admin)
            {
                ...
                return RedirectToAction(nameof(ManageUsers), new { area = "Admin" });
            }
        ...
        // POST: /Admin/Admin/ChangeAccountStatus
        [HttpPost]
        ...
        // POST: /Admin/Admin/ResetUserPassword
        [HttpPost]
        ...
        // URL: /Admin/Admin/ContentManagement
        ...
        // URL: /Admin/Admin/ManageRecyclingCategories
        ...
        // URL: /Admin/Admin/ManageRecyclingCenters
        ...
        // URL: /Admin/Admin/ManageCollectionSchedules
        ...
        // URL: /Admin/Admin/CategoryManagement
        ...
        // URL: /Admin/Admin/ReviewCommunityItems
        ...
        // POST: /Admin/Admin/ApproveItem/{id}
        [HttpPost]
        ...
        // POST: /Admin/Admin/RejectItem/{id}
        [HttpPost]
        ...
        // URL: /Admin/Admin/GamificationManagement
        ...
        // URL: /Admin/Admin/ManageChallenges
        ...
        // URL: /Admin/Admin/AdjustEcoPoints
        [HttpGet]
